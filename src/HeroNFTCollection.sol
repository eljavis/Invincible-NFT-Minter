...
contract HeroNFTCollection is ERC721 {
    ...
    constructor(string memory name_, string memory symbol_, uint256 totalSupply_, uint256 mintPrice_, string memory baseUri_) ERC721(name_, symbol_) {
